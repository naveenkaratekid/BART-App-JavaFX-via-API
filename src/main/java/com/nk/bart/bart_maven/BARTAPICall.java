	...
	public static void getTripInfo(String start, String dest, Map<String, String> stationAbbr) throws Exception
	{
		...
		try
		{
			...
			for(int i = 0; i < order.size(); i++) 
			{
		        ...
		        t1.setFont(Font.font("Arial", FontWeight.NORMAL, 10));
		        gp.add(t1,0,0);
		        ...
		        t2.setFont(Font.font("Arial", FontWeight.NORMAL, 10));
		        gp.add(t2,0,0);
		        ...
		        t3.setFont(Font.font("Arial", FontWeight.NORMAL, 10));
		        gp.add(t3,0,0);
		        ...
		        t4.setFont(Font.font("Arial", FontWeight.NORMAL, 10));
		        gp.add(t4,0,0);
		        ...
		        lineText.setFont(Font.font("Arial", FontWeight.EXTRA_BOLD, 10));
		        ...
		        t8.setTranslateY(-78 + (135 * i));
		        System.out.println(t8.getTranslateY());
